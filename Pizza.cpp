...
int main()
{
	...
	cout << "\n Ваш заказ: " << endl;
	cout << " Пицца:" << pizzaID << " количество(шт):" << temp << " стоимость:";
	cout << selPizPrice <<"$" << endl;;
	cout << " Напиток:" << drinkID << " количество(шт):";
	cout << drinkAmount << " стоимость:" << selDrPrice<<"$" << endl;
	cout << " Сумма к оплате: " << sumOrder << "$" << endl;
